  ...
  return (
    <main className="narrow-page">
      ...
      <div className="notice-card">
        ...
        <p className="small-note">
          Explanations in your report are
          generated by a third-party AI
          service from published Malaysian
          statistics only. Questions you
          type into the assistant are
          matched to an item on your report
          inside your own browser and are
          not sent anywhere.
        </p>
      </div>
